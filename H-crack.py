...
def HRIDOY():
    ...
    jalan('\033[1;91m[\033[1;92m3\033[1;91m]\033[1;92m CONTACT MY 2d FACEBOOK')
    jalan('\033[1;91m[\033[1;92m4\033[1;91m]\033[1;92m Subscribe my YouTube channel')
    jalan('\033[1;91m[\033[1;92m0\033[1;91m]\033[1;91m EXIT')
    opt = input('\n\x1b[1;32m\033[1;91m[\033[1;92m✔\033[1;91m]\033[1;32mCHOOSE : ')
    if opt == '1':
        main()
    if opt == '2':
        os.system('xdg-open https://t.me/ogggy69')
        return None
    if opt == '3':
        os.system('xdg-open https://github/mrogggy')
        return None
    if opt == '4':
        os.system('xdg-open https://facebook.com/hridoybhaiaaa')
    if opt == '0':
        os.system('exit')
        return None
...
logo = """  
 ...
 _____ _   _   ___   _   _   ___  ______ _____  ___  ______ 
/  ___| | | | / _ \ | | | | / _ \ | ___ \_   _|/ _ \ | ___ \
\ `--.| |_| |/ /_\ \| |_| |/ /_\ \| |_/ / | | / /_\ \| |_/ /
 `--. \  _  ||  _  ||  _  ||  _  ||    /  | | |  _  ||    / 
/\__/ / | | || | | || | | || | | || |\ \ _| |_| | | || |\ \ 
\____/\_| |_/\_| |_/\_| |_/\_| |_/\_| \_|\___/\_| |_/\_| \_|
...
def main():
    ...
    os.system('xdg-open https://t.me/+wrabAHZ6eY4wNDFl')
    os.system('clear')
    print('H R I D O Y')
    limit = int(input('\033[1;92mEXAMPLE: 2000, 5000, 10000, 40000\n\n\033[1;91mCHOOSE CLONING LIMIT : '))
    os.system('xdg-open https://www.facebook.com/hridoybhaiaaa')
...
def rcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			sys.stdout.write('\r\33[1;92m[HRIDOY-%s] \33[1;90m[OK:\33[1;92m%s\33[1;90m]'%(loop,len(oks))),
			sys.stdout.flush()
